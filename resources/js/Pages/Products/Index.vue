        ...
        <div class="flex h-screen bg-gray-800 text-white">
            ...
            <div class="w-1/4 bg-gray-900 p-6 shadow-lg rounded-r-lg">
                ...
                <div class="space-y-4 mt-6">
                    <Link
                        ...
                        class="block py-3 px-5 text-sm text-white rounded-lg transition-all transform hover:scale-105 border-b border-gray-700"
                        :class="{
                            'bg-blue-700 font-bold': category && category.id === cat.id,
                            'bg-gray-600 hover:bg-blue-700': !(category && category.id === cat.id)
                        }">
                        {{ cat.name }}
                    </Link>
                </div>
            ...
            <div class="flex-1 bg-gray-800 p-6 overflow-scroll" style="scrollbar-width: none;">
                <div class="flex justify-between items-center w-full mb-5">
                    <h1 v-if="!category" class="text-3xl font-bold text-gray-100 mb-6">Products List</h1>

                    <h1 class="text-3xl font-bold text-gray-100 mb-6" v-if="category">{{ category.name }}</h1>
